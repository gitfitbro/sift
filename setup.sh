...
echo "  sift init                      # First-time setup wizard"
echo "  sift demo                      # See sift in action (no API key needed)"
echo ""
echo "Or jump right in:"
echo "  sift new hello-world --name test   # Create a minimal session"
echo "  sift run test                      # Run it interactively"
echo ""
echo "Data Locations:"
